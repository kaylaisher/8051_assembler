...
class LCALL:
    def lcall(x_split, text_file, log):
        ...
        for address_detail in Data.addr_data:
            ...
            if len(address_detail) >1 and  x_split[1] in address_detail[1]:
                
                label_location = address_detail[2]
                break
        # print("label location initial: " + str(label_location))
        label_location = hex(label_location)
        # print("label location hex: " + label_location)
...
class JZ:
    def jz(x_split, text_file, log):
        ...
        for address_detail1 in Data.addr_data:
            ...
            if x_split[1] == address_detail1[1][0]:
        ...
        for address_detail2 in Data.addr_data:
            ...
            if x_split == address_detail2[1]:
                print("x_split: ")
                print(x_split)
                print("address_detai2: ")
                print(address_detail2)
                print("address JZ? ")
                print(address_detail2)
                current_location = address_detail2[3]
                break
        ...
        offset = tool.offset(label_location, current_location)
        print(type(offset))
        print("offset: ")
        print(offset)
        ...
        # second_machine_code = str(offset)
        # print("offset: ")
        # print(offset)
