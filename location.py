...
class Location:
    ...
    def MOVdirect_direct_location(x_split, text_file, log):
            clean_op = tool.check_format(x_split[0])
    ...
    def MOVreg_imm_location(x_split, text_file, log):
        clean_op = tool.check_format(x_split[0])
        log.write("OPCODE : " + clean_op + '\n')
        Data.current_addr_cnt = Data.next_addr_cnt
        Data.addr_data.append(Data.addr_detail)
    ...
    def MOVRn_direct_location(x_split, text_file, log):
        clean_op = tool.check_format(x_split[0])
        log.write("OPCODE : " + clean_op + '\n')
        Data.current_addr_cnt = Data.next_addr_cnt
        Data.addr_data.append(Data.addr_detail)
    ...
    def SUBBA_Ri_location(x_split, text_file, log):
        clean_op = x_split[0]
        Data.current_addr_cnt = Data.next_addr_cnt
        Data.addr_data.append(Data.addr_detail)
    ...
    def SUBBA_Rn_location(x_split, text_file, log):
        clean_op = x_split[0]
        Data.current_addr_cnt = Data.next_addr_cnt
        Data.addr_data.append(Data.addr_detail)
    ...
    def XRLdirect_imm_location(x_split, text_file, log):
        clean_op = x_split[0]
        Data.current_addr_cnt = Data.next_addr_cnt
        Data.addr_data.append(Data.addr_detail)
    ...
    def XRLdirect_A_location(x_split, text_file, log):
        clean_op = x_split[0]
        Data.current_addr_cnt = Data.next_addr_cnt
        Data.addr_data.append(Data.addr_detail)
    ...
    def XRLA_direct_location(x_split, text_file, log):
        clean_op = x_split[0]
        Data.current_addr_cnt = Data.next_addr_cnt
        Data.addr_data.append(Data.addr_detail)
    ...
    def INCRi_location(x_split, text_file, log):
        clean_op = x_split[0]
        Data.current_addr_cnt = Data.next_addr_cnt
        Data.addr_data.append(Data.addr_detail)
    ...
    def INCRn_location(x_split, text_file, log):
        clean_op = x_split[0]
        Data.current_addr_cnt = Data.next_addr_cnt
        Data.addr_data.append(Data.addr_detail)
