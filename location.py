...
class Location:
    def label_location(x_split,  log):
        ...
        Data.addr_detail = [Data.addr_index, x_split, Data.current_addr_cnt, Data.next_addr_cnt]
        Data.addr_data.append(Data.addr_detail)
        #Data.each_line.append([Data.addr_index, x_split])
        print(Data.addr_detail)
